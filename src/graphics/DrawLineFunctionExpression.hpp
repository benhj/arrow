...
namespace arrow {
    ...
    class DrawLineFunctionExpression final : public Expression, public BuiltInFunctionExpression
    {
      public:
    ...
    class DrawLineFunctionExpressionBuilder final : public BuiltInFunctionExpressionBuilder
    {
      public:

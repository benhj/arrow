...
#include "FillCircleFunctionExpressionEvaluator.hpp"
...
namespace arrow {
    ...
    FillCircleFunctionExpressionEvaluator::FillCircleFunctionExpressionEvaluator(FillCircleFunctionExpression expression)
      : m_expression(std::move(expression))
    {
    }
    Type FillCircleFunctionExpressionEvaluator::evaluate(Environment & environment) const
    {
        ...
        GraphicsCanvas::fillCircle(castedX, castedY, castedRad, castedR, castedG, castedB);

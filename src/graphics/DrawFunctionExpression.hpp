...
namespace arrow {
    ...
    class DrawFunctionExpression : public Expression, public BuiltInFunctionExpression
    {
      public:
    ...
    class DrawFunctionExpressionBuilder : public BuiltInFunctionExpressionBuilder
    {
      public:

...
namespace arrow {
    ...
    class FillCircleFunctionExpression final : public Expression, public BuiltInFunctionExpression
    {
      public:
    ...
    class FillCircleFunctionExpressionBuilder final : public BuiltInFunctionExpressionBuilder
    {
      public:

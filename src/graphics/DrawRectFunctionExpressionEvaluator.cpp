...
#include "DrawRectFunctionExpressionEvaluator.hpp"
...
namespace arrow {
    ...
    DrawRectFunctionExpressionEvaluator::DrawRectFunctionExpressionEvaluator(DrawRectFunctionExpression expression)
      : m_expression(std::move(expression))
    {
    }
    Type DrawRectFunctionExpressionEvaluator::evaluate(Environment & environment) const
    {
        ...
        GraphicsCanvas::drawRect(castedX, castedY, castedW, castedH, castedR, castedG, castedB);

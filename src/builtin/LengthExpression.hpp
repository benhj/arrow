...
namespace arrow {
    ...
    class LengthExpression final : public Expression, public BuiltInFunctionExpression
    {
      public:
    ...
    class LengthExpressionBuilder final : public BuiltInFunctionExpressionBuilder
    {
      public:

...
namespace arrow {
    ...
    class StringInputExpression final : public Expression, public BuiltInFunctionExpression
    {
      public:
    ...
    class StringInputExpressionBuilder final : public BuiltInFunctionExpressionBuilder
    {
      public:

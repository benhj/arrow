...
namespace arrow {
    ...
    class MapKeysFunctionExpression : public Expression, public BuiltInFunctionExpression
    {
      public:
    ...
    class MapKeysFunctionExpressionBuilder : public BuiltInFunctionExpressionBuilder
    {
      public:

...
namespace arrow {
    ...
    class ExpFunctionExpression final : public Expression, public BuiltInFunctionExpression
    {
      public:
        ExpFunctionExpression(long const lineNumber);
    ...
    class ExpFunctionExpressionBuilder final : public BuiltInFunctionExpressionBuilder
    {
      public:
        ...
        std::shared_ptr<Expression> build(long const ln) const override {
            return std::make_shared<ExpFunctionExpression>(ln);
        }
    };

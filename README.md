...
A weakly typed interpreted programming language. (A huge thanks to [Jorge Prendes](https://github.com/jprendes/) for putting the [webassembly based demo](https://jprendes.github.io/arrow-playground/) together!).
